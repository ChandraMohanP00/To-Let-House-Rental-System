...
<html lang="en">
  ...
  <body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">To-Let</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Make a quick search at our number of To-Let Houses!</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
